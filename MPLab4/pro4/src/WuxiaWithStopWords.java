...
public class WuxiaWithStopWords {
  ...
  //  static{
   ...
   // }
    ...
    public static void main(String[] args) {
        try {
            createHBaseTable("WuxiaStopWords");
...
// default RecordReader: LineRecordReader; key: line offset; value: line string
        {
            ...
            while (itr.hasMoreTokens()) {
                ...
                if(r.isEmpty()) {
                    Text keyinfo = new Text(keystr + ':' + filename);
    ...
    public static class InvertedIndexReducer extends Reducer<Text, Text, Text,Text> {
        ...
        protected void setup(Context context) throws IOException, InterruptedException{
            con = ConnectionFactory.createConnection(configuration);
            table = con.getTable(TableName.valueOf("WuxiaStopWords"));
        }
